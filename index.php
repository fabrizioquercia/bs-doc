...
.bs-callout-info h4 {
    ...
    <body class="homepage"  style="background-color:#f7f7f7">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href=".">
				<i class="fa fa-map"></i>&nbsp;&nbsp;MkDocs Help System v1.0
			</a>
...
<li >
    <a href="about/release-notes/">Release notes</a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <li >
                        <a rel="prev" href="user-guide/configuration/">
    ...
    <ul class="nav bs-sidenav">
        ...
        <li class="main active"><a href="#mkdocs"><strong>MkDocs</strong></a></li>
